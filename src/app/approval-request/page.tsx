// src/app/approval-request/page.tsx
"use client";
...
export default function ApprovalRequestPage() {
  ...
  const [requestType, setRequestType] = useState<'UPDATE_SUBMITTED_FORM' | 'UPDATE_PREVIOUS_MONTH' | 'DELETE_RECORD'>('UPDATE_SUBMITTED_FORM');
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select
                  id="requestType"
                  value={requestType}
                  onChange={(e) => setRequestType(e.target.value as 'UPDATE_SUBMITTED_FORM' | 'UPDATE_PREVIOUS_MONTH' | 'DELETE_RECORD')}
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500">
                  Be specific about what changes you need and why theyre required.
                </p>
              </div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                  ...
                  {selectedFile ? (
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-gray-500">
                        PDF, Word documents, or images up to 2MB
                      </p>
                      <Button
                        type="button"
                        variant="outline"
