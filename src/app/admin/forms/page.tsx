...
const mockSubmissions: UserSubmission[] = [
  ...
  },
  {
    id: '3',
    userId: 'user3',
    userName: 'PQR Recovery Solutions',
    userEmail: 'pqr@recovery.com',
    formType: 'assetManagement',
    formTitle: 'Asset Management Declaration',
    status: 'APPROVED',
    submittedAt: new Date('2025-08-02T09:45:00'),
    reviewedAt: new Date('2025-08-03T11:20:00'),
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-8">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2 mt-4">
            Form Submissions Management
          </h1>
          <p className="text-gray-600 dark:text-gray-400">
            Review and manage all agency form submissions
          </p>
        </div>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              ...
              <select
                value={filterStatus}
                onChange={(e) => setFilterStatus(e.target.value as 'ALL' | 'SUBMITTED' | 'APPROVED' | 'REJECTED')}
                        ...
                        <div className="flex items-center gap-2">
                          <Button
                            ...
                            onClick={() => {
                              ...
                              window.location.href = `/admin/forms/${submission.formType}/${submission.id}`;
                            }}
                          >
