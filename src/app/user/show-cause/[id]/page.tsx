...
type SuccessReturn = Extract<ShowCauseDetailsReturn, { success: true }>;
type NoticeType = SuccessReturn["notice"];
  ...
  if (!result.success) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <PageHeader returnHref="/user/show-cause" returnLabel="Back to All Notices" />
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="container mx-auto p-8 space-y-8">
        <ShowCauseNoticeClient 
          notice={result.notice as NoticeType}
          isAgencyView={!result.isAdmin} 
        />
      </div>
    </div>
  );
